...
def _main():
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='logs/444/trained_weights_stage_1.h5') # make sure you know what you freeze

    logging = TensorBoard(log_dir=log_dir,histogram_freq=1,embeddings_freq=1)
